...
const ones = new TotalOneNumber({ val: 1 , description: "1 per 1 " });
const twos = new TotalOneNumber({ val: 2 , description: "2 per 2" });
const threes = new TotalOneNumber({ val: 3 , description: "3 per 3 "});
const fours = new TotalOneNumber({ val: 4 , description: "4 per 4"});
const fives = new TotalOneNumber({ val: 5 , description: "5 per 5"});
const sixes = new TotalOneNumber({ val: 6 , description: "6 per 6"});
